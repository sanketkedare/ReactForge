...
function ModalDialogDemo() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-8">
      ...
      {/* Triggers Dashboard */}
      <div className="w-full p-8 rounded-3xl border border-slate-800/80 bg-slate-900/60 backdrop-blur-md shadow-2xl space-y-8 text-center">
