...
function StopwatchTimerDemo() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto p-8 rounded-3xl border border-slate-800/80 bg-slate-900/60 backdrop-blur-md shadow-2xl space-y-8 text-center">
      {/* Mode Switcher Tabs */}
...
export default function StopwatchTimerPage() {
  return (
    <DynamicTaskClient slug="stopwatch-timer">
      <StopwatchTimerDemo />
    </DynamicTaskClient>
  );
}
